...
//        private final String SEARCH_URL = "http://10.3.0.54:5000/supermercado/api/v1.0/search/"; //connecting <--commented
        private final String SEARCH_URL = "http://192.168.3.126/edushare/api/v1.0/search/"; //connecting <--added
        ...
        protected ArrayList<Item> doInBackground(Void... params) {
            ...
            try {
                ...
                //JSONObject jsnobject = new JSONObject(mStringData); <-- commented
                JSONArray resultARRAY = new JSONArray(mStringData); //jsnobject.getJSONArray(mSearchString); <-- edited
